...
function SocialIcon({ href, title, ariaLabel, children }: { href: string; title: string; ariaLabel: string; children: ReactElement }) {
    return (
        <a
            ...
            title={title}
            className="hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-offset-2 rounded"
            target="_blank"
            ...
            <div className="px-(--pc-padding) mx-auto py-6 grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                    ...
                    <nav aria-label="Navegação do rodapé">
                        <ul className="space-y-2">
                            <li>
                                <Link href="/" className="text-sm hover:underline">Início</Link>
                            </li>
                            <li>
                                <Link href="/#most-voted" className="text-sm hover:underline">Mais votadas</Link>
                            </li>
                            <li>
                                <Link href="/#all-recipes" className="text-sm hover:underline">Todas as receitas</Link>
                            </li>
                            <li>
                ...
                <div>
                    ...
                    >
                        ...
                        <input
                            ...
                            required
                            className="rounded-xl px-3 py-2 text-sm bg-transparent border-2 border-background/20 focus:outline-none focus:border-background"
                        />
                ...
                <div>
                    ...
                    <address className="not-italic">
                        ...
                        <div className="flex items-center gap-3">
                            <SocialIcon href="#" ariaLabel="GitHub Okorok" title="GitHub">
                            ...
                            <SocialIcon href="#" ariaLabel="Instagram Okorok" title="Instagram">
                                <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width={24} height={24} className="text-background" aria-hidden="false">
